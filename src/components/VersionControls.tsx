...
export const VersionControls: React.FC<VersionControlsProps> = ({ 
  ...
  const hasActualChanges = React.useMemo(() => {
    if (!schema || !patches) return isModified;
    
    try {
      // Import the applySelectedPatches function
      const { applySelectedPatches } = require('@/lib/versionUtils');
      ...
      if (selectedPatches.length === 0) {
        ...
        return Object.keys(parsedSchema).length > 0;
      }
      ...
      console.log('Version controls checking for actual changes:', {
      ...
      console.error('Error checking for actual changes:', err);
