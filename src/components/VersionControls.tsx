...
export const VersionControls: React.FC<VersionControlsProps> = ({ 
  ...
  const hasActualChanges = React.useMemo(() => {
    ...
    try {
      ...
      console.log('🔍 VersionControls: Checking for actual changes (triggered by description/version change):', {
      ...
      console.log('📊 VersionControls: Deep object comparison (commit intent detected):', {
